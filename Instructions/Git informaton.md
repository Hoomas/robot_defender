...
С их помощью осуществляется работа и оформление преоктов. В фалйе [workflow.md](workflow.md) находится структура проекта, и описана логика работы с ветвями.
